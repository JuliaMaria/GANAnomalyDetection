...
import model
from model_training import anomaly_detection
...
if __name__ == "__main__":
    ...
    for i in range(1, 10):
        train_dataset = SignalDataset(path=f'../prepared_data/A-{i}-train.csv')
        test_dataset = SignalDataset(path=f'../prepared_data/A-{i}-test.csv')
        batch_size = 64
        ...
        anomaly_detection.test(test_loader, encoder, decoder, critic_x, dataset_idx=i)
