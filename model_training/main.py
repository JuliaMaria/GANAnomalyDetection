...
if __name__ == "__main__":
    # dataset = pd.read_csv('prepared_data/A-1.csv')
    ...
    train_dataset = SignalDataset(path='../prepared_data/A-5-train.csv')
    test_dataset = SignalDataset(path='../prepared_data/A-5-test.csv')
    batch_size = 64
